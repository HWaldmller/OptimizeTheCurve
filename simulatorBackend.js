...
function calculateNew(exportData) {
    ...
    if (exportData) {
        ...
        for (i = 0; i < durationSimulation[0] + zeroPoint; i++) {
            writeData[52 * (i + 1) + 1] = totalMinNeedingIntensiveCare[0][i];
            writeData[52 * (i + 1) + 2] = "\t";
            writeData[52 * (i + 1) + 3] = totalNeedingIntensiveCare[0][i];
            writeData[52 * (i + 1) + 4] = "\t";
            writeData[52 * (i + 1) + 5] = totalMaxNeedingIntensiveCare[0][i];
            writeData[52 * (i + 1) + 6] = "\t";
            writeData[52 * (i + 1) + 7] = hospitalCapacity[0][i];
            writeData[52 * (i + 1) + 8] = "\t";
            writeData[52 * (i + 1) + 9] = totalSusceptible[0][i];
            writeData[52 * (i + 1) + 10] = "\t";
            writeData[52 * (i + 1) + 11] = totalInfectious[0][i];
            writeData[52 * (i + 1) + 12] = "\t";
            writeData[52 * (i + 1) + 13] = totalRemoved[0][i];
            writeData[52 * (i + 1) + 14] = "\t";
            writeData[52 * (i + 1) + 15] = desiredContactReduction[0][i];
            writeData[52 * (i + 1) + 16] = "\t";
            writeData[52 * (i + 1) + 17] = actualContactReduction[0][i];
            writeData[52 * (i + 1) + 18] = "\t";
            writeData[52 * (i + 1) + 19] = averageContactReduction[0][i];
            writeData[52 * (i + 1) + 20] = "\t";
            writeData[52 * (i + 1) + 21] = totalMinDeceased[0][i];
            writeData[52 * (i + 1) + 22] = "\t";
            writeData[52 * (i + 1) + 23] = totalDeceased[0][i];
            writeData[52 * (i + 1) + 24] = "\t";
            writeData[52 * (i + 1) + 25] = totalMaxDeceased[0][i];
            writeData[52 * (i + 1) + 26] = "\t";

            if (numberPopulations > 1) {
                writeData[52 * (i + 1) + 27] = totalMinNeedingIntensiveCare[1][i];
                writeData[52 * (i + 1) + 28] = "\t";
                writeData[52 * (i + 1) + 29] = totalNeedingIntensiveCare[1][i];
                writeData[52 * (i + 1) + 30] = "\t";
                writeData[52 * (i + 1) + 31] = totalMaxNeedingIntensiveCare[1][i];
                writeData[52 * (i + 1) + 32] = "\t";
                writeData[52 * (i + 1) + 33] = hospitalCapacity[1][i];
                writeData[52 * (i + 1) + 34] = "\t";
                writeData[52 * (i + 1) + 35] = totalSusceptible[1][i];
                writeData[52 * (i + 1) + 36] = "\t";
                writeData[52 * (i + 1) + 37] = totalInfectious[1][i];
                writeData[52 * (i + 1) + 38] = "\t";
                writeData[52 * (i + 1) + 39] = totalRemoved[1][i];
                writeData[52 * (i + 1) + 40] = "\t";
                writeData[52 * (i + 1) + 41] = desiredContactReduction[1][i];
                writeData[52 * (i + 1) + 42] = "\t";
                writeData[52 * (i + 1) + 43] = actualContactReduction[1][i];
                writeData[52 * (i + 1) + 44] = "\t";
                writeData[52 * (i + 1) + 45] = averageContactReduction[1][i];
                writeData[52 * (i + 1) + 46] = "\t";
                writeData[52 * (i + 1) + 47] = totalMinDeceased[1][i];
                writeData[52 * (i + 1) + 48] = "\t";
                writeData[52 * (i + 1) + 49] = totalDeceased[1][i];
                writeData[52 * (i + 1) + 50] = "\t";
                writeData[52 * (i + 1) + 51] = totalMaxDeceased[1][i];
                writeData[52 * (i + 1) + 52] = "\n";
            }
        }
